                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-hover">
                                ...
                                <tbody>
                                <% for(Utilisateur u : (List<Utilisateur>)liste.getListe()){ %>
                                    <tr>
                                        <td><% out.print(u.getId()); %></td>
                                        <td><% out.print(u.getFullName()()); %></td>
                                        <td><% out.print(u.getActivite()); %></td>
                                        <td><a class="btn btn-danger" href="/SuiviRegime/Administrateur/Sport/delete?id=<% out.print(c.getId()); %>">Supprimer</a></td>
                                    </tr>
                                <% } %>
                                </tbody>
                            </table>
