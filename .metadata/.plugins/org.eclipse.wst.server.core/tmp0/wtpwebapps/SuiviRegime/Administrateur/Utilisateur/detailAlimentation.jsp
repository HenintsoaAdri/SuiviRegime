...
%>
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Utilisateurs - Alimentation</h2>
                    <ul class="breadcrumb">
					  ...
					  <li class="active">D&eacute;tails Alimentation</li>
					</ul>
                </div>
                <!-- /.col-lg-12 -->
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-body -->
                        <% }
                            else out.print("Aucune alimentation enregistr&eacute;e pour l'instant"); %>
                    </div>
                    <!-- /.panel -->
                </div>
                <!-- /.col-lg-12 -->
