         ...
         <div id="page-inner">
             <div class="row">
             	<div class="col-xs-12">
             		<h2>Alimentation</h2>
             		<p class="text-muted">
             			Voici une liste de quelques conseils d'Alimentation que vous pourriez suivre! N'hésitez pas à enregistrer votre poids et voir quels conseils vous conviennent le mieux!
             		</p>
             	</div>
             </div>
