                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3>Modifier votre r&eacute;gime</h3>
                         <p>
                        Pour un suivi de votre poids et de vos habitudes alimentaires et sportives, créez un nouveau r&eacute;gime! On vous aidera &agrave; rep&eacute;rer les bonnes habitudes qui vous font perdre vos kilos en trop! De bon conseils par jour vous seront offert! Donnez-nous la p&eacute;riode du r&eacute;gime, votre poids initial et le poids idéal, on s'occupe de tout! 
                        </p>
                    </div>
                </div>
                <!-- /. ROW  -->
