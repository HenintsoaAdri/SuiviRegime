         ...
         <div id="page-inner">
             <div class="row">
             	<div class="col-xs-12">
             		<h2>R&eacute;gime</h2>
             		<p class="text-muted">
             			Le régime que vous suivez actuellement est le régime Actif. 
             			<br>Activez le régime que vous voudriez suivre pour pouvoir inscrire les informations le concernant.
